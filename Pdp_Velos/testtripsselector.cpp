...
go_bandit([](){
    describe("test tripsselector", [](){
        ...
        t1.startDateTime = QDateTime(QDate(2016, 7, 7), QTime(13, 50));
        t1.endDateTime =  QDateTime(QDate(2016, 7, 10), QTime(14, 30));
        t1.startStationId = 1;
        t1.endStationId = 1;
        trips1.append(t1);
        ...
        t3.startDateTime = QDateTime(QDate(2016, 4, 20), QTime(15, 40));
        ...
        t4.startDateTime = QDateTime(QDate(2016, 4, 20), QTime(15, 40));
        ...
        Trip t5;
        t5.startDateTime = QDateTime(QDate(2016, 4, 20), QTime(12, 40));
        t5.endDateTime = QDateTime(QDate(2016, 4, 21), QTime(13, 50));
        t5.startStationId = 0; 
        t5.endStationId = 1; // this station is correct so the trip must be accept
        trips3.append(t5);

        Trip t6;
        t6.startDateTime = QDateTime(QDate(2016, 4, 20), QTime(3, 40));
        t6.endDateTime = QDateTime(QDate(2016, 4, 21), QTime(3, 50));
        t6.startStationId = 1; // this one too
        t6.endStationId = 0;
        trips3.append(t6);

        Trip t7;
        t7.startDateTime = QDateTime(QDate(2016, 4, 20), QTime(3, 40));
        t7.endDateTime = QDateTime(QDate(2016, 4, 21), QTime(3, 50));
